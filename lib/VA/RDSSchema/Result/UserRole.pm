use utf8;
package VA::RDSSchema::Result::UserRole;
...
Related object: L<VA::RDSSchema::Result::Role>

=cut

__PACKAGE__->belongs_to(
  "role",
  "VA::RDSSchema::Result::Role",
  { id => "role_id" },
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ayhpLX26G4trDZtQgcp9nw
