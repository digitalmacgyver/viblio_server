...
//				    console.log( 'hiding because hotSpotScrolling is false' );
...
//					    console.log( 'hiding because scrollable area ' + el.data("scrollableAreaWidth") + ' is shorter than scroll wrapper ' +  el.data("scrollWrapper").innerWidth() );
						el.data("scrollingHotSpotLeft").hide();
						el.data("scrollingHotSpotRight").hide();
					}
...
//					    console.log( 'hide left, show right' );
						el.data("scrollingHotSpotLeft").hide();
						el.data("scrollingHotSpotRight").show();
						// Callback
...
//					    console.log( 'hide right, show left' );
						el.data("scrollingHotSpotLeft").show();
						el.data("scrollingHotSpotRight").hide();
						// Callback
...
//				    console.log( 'hiding because auto scroll is true' );
					el.data("scrollingHotSpotLeft").hide();
					el.data("scrollingHotSpotRight").hide();
				}
			}
...
//		    console.log( 'recalculating area width' );
