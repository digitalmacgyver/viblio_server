...
function loadHtml5LightBox(jsFolder) {
        ...
        (function($) {
                ...
                $.fn.html5lightbox = function(options) {
                        ...
                        options.isIE9 = (navigator.userAgent.match(/msie/i) != null) && options.html5VideoSupported;
                        options.isIE678 = (navigator.userAgent.match(/msie/i) != null) && !options.isIE9;     
			    ...
			    console.log( 'type is ' + options.elemArray[options.curElem][0] );
			    ...
			    $container.html("<div class='fplayer' style='position:absolute;display:block;width:" + w + "px;height:" + h + "px;'>" +
                        ...
                        function checkType(href)
                        {
                                ...
                                if ( href.match(/\.(flv|mp4|m4v|ogv|ogg|webm|mov)(.*)?$/i) ) 
                                        return 2;
